...
var linkItems = [
  ...
  "companies__company_id__integrator_get_response:integrator_getAll",
  "companies__company_id__integrator_post_request:integrator_post",
  "companies__company_id__integrator__integrator_id__get_response:integrator_getId",
  "companies__company_id__integrator__integrator_id__post_request:integrator_postId",
  "companies__company_id__integratortype_get_response:integratortype_getAll",
  "companies__company_id__integratortype_post_request:integratortype_post",
  "companies__company_id__integratortype__integratortype_id__get_response:integratortype_getId",
  "companies__company_id__integratortype__integratortype_id__post_request:integratortype_postId",
