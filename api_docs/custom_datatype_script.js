...
var linkItems = [
  ...
  "integrator_get_response:integrator_getAll",
  "integrator_post_response:integrator_post",
  "companies__company_id__integrator_get_response:integrator_getId",
  "companies__company_id__integrator_post_request:integrator_postId",
  "integratortype_get_response:company_getAll",
  "integratortype_post_request:company_post",
  "companies__company_id__integratortype_get_response:integratortype_getId",
  "companies__company_id__integratortype_get_response:integratortype_postId",
